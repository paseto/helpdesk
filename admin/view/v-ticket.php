...
?>
<div id="tid" tid="<?php echo $ticketid; ?>" uid="<?php echo $s_uid; ?>" filefolder="<?php echo $files_to_delete; ?>"></div>
    ...
    <div id="table-wrapper">
        ...
        <p><input class="btn collision_disable" name="save" type="submit" value="<?php echo $lang['generic-change']; ?>" /></p>
        <?php
...
?>
    ...
    ?>
		...
		<div class="ticket-message staff layout-padding <?php echo $staff_block; ?>" id="<?php echo $ticket_update["ID"]; ?>">
	...
	?>
    	...
    	<div class="ticket-message layout-padding <?php echo $staff_block; ?>" id="<?php echo $ticket_update["ID"]; ?>">
        ...
        <div class="form layout-padding" id="form_background">
			...
			<form id="form_add_update" name="form_add_update" method="post" action="<?php echo $_SERVER['REQUEST_URI']."#form"; ?>" enctype="multipart/form-data">            
				...
				?>	            
                    ...
                    <p><input style="min-width:100%" type="text" id="aa_forward_to" name="aa_forward_to" placeholder="<?php echo $lang['ticket-forward-to']; ?>" value="<?php echo @$forward_to; ?>" /></p>
                ...
                <textarea rows="10" id="reply" name="reply" placeholder="Write update"><?php echo @$_POST["reply"].nl2br($s_usign); ?></textarea>
                ...
                <div>
                <p><input class="btn" type="submit" id="Form_Reply" name="Form_Reply" value="<?php echo $lang['generic-save']; ?>" /></p>
                </div>
